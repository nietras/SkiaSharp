...
#### Type Changed: SkiaSharp.Views.Forms.Resource.Animation
...
public static int sliding_tabs;
...
```csharp
public static int FallbackTabbarDoNotUse;
public static int FallbackToolbarDoNotUse;
public static int Tabbar;
public static int Toolbar;
