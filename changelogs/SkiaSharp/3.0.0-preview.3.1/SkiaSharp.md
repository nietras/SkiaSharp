...
```diff
 [Obsolete ("Use CreateAlphaThreshold(SKRegion, float, float, SKImageFilter) instead.")]
...
```diff
 public SKImageFilter CreateAlphaThreshold (SKRectI region, float innerThreshold, float outerThreshold, SKImageFilter input--- = NULL---)
