import { config as unoConfig } from "/SkiaSharp/staging/4169/fiddle/package_a5633324362324bb6c2df6eef238ea0169ec4d51/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('cc08697d-c581-4bc9-9d7c-7d1948b9812a').then(async function (cache) {
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== 'cc08697d-c581-4bc9-9d7c-7d1948b9812a';
