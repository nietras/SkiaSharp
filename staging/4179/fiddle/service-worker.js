import { config as unoConfig } from "/SkiaSharp/staging/4179/fiddle/package_a5633324362324bb6c2df6eef238ea0169ec4d51/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('e6d5d3b7-5550-4c3f-a9d4-eab78ed40065').then(async function (cache) {
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== 'e6d5d3b7-5550-4c3f-a9d4-eab78ed40065';
