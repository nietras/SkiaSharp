import { config as unoConfig } from "/SkiaSharp/staging/4179/gallery-uno/package_5947537d7caf45d2b637e3d7377d5ca7521a9741/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('abc7c92e-935e-4995-a3e0-e8a8682ca41c').then(async function (cache) {
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== 'abc7c92e-935e-4995-a3e0-e8a8682ca41c';
